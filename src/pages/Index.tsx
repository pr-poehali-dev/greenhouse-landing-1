...
const ADVANTAGES = [
  { icon: "Leaf", title: "Экологичные материалы", desc: "Только сертифицированный поликарбонат без вредных добавок. Безопасно для растений и людей." },
  { icon: "Shield", title: "Гарантия 3–5 лет", desc: "Официальная гарантия на все конструкции. Приедем и устраним любой дефект бесплатно." },
  { icon: "Truck", title: "Доставка и монтаж", desc: "Привезём и соберём теплицу на вашем участке. Работаем по Москве и МО." },
  { icon: "Sun", title: "Круглогодичное использование", desc: "Усиленные модели выдерживают снеговую нагрузку до 180 кг/м² и морозы до −40°C." },
  { icon: "Wrench", title: "Индивидуальные размеры", desc: "Изготовим теплицу по вашим параметрам. Нестандартный участок — не проблема." },
  { icon: "Sprout", title: "Богатый урожай", desc: "Поликарбонат рассеивает свет равномерно — растения дают на 30% больше урожая." },
];
